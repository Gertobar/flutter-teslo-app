...
class Price extends FormzInput<double, PriceError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == PriceError.format ) return 'El campo no contiene el formato esperado';
    if ( displayError == PriceError.value ) return 'El campo tiene que ser un numero mayor o igual 0';
    return null;
  }
