...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == StockError.empty ) return 'El campo es requerido';
            if ( displayError == StockError.format ) return 'El campo no contiene el formato esperado';
    if ( displayError == StockError.value ) return 'El campo tiene que ser un numero mayor o igual 0';
    return null;
  }
