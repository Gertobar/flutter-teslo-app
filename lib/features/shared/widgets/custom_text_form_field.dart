    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          errorBorder: border.copyWith( borderSide: BorderSide( color: const Color.fromARGB(0, 198, 40, 40) )),
          focusedErrorBorder: border.copyWith( borderSide: BorderSide( color: const Color.fromARGB(0, 198, 40, 40) )),
          isDense: true,
